                        ...
                        <form method="POST" action="{{ route('service-provider.store') }}">
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="text" name="share_capital" id="share_capital" class="form-control border border-2 p-2" value="{{ old('share_capital') }}">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="text" name="monthly_base_value" id="monthly_base_value" class="form-control border border-2 p-2" value="{{ old('monthly_base_value') }}">
