...
<aside
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-2 d-flex text-wrap align-items-center" href=" {{ route('dashboard') }} ">
            <img src="{{ asset('assets') }}/img/esterni/logo_branca.png" class="navbar-brand-img h-100 w-auto" alt="main_logo">
        </a>
    </div>
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link text-white {{ $activePage == 'service-provider' ? ' active bg-gradient-primary' : '' }} "
                    ...
                    <span class="nav-link-text ms-1">Prestadores</span>
                </a>
            </li>
            <li class="nav-item">
            ...
            @can('isAdmin')
                <li class="nav-item">
                    <a class="nav-link text-white {{ $activePage == 'Administrador' ? ' active bg-gradient-primary' : '' }} "
