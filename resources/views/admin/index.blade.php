<x-layout bodyClass="g-sidenav-show  bg-gray-200">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg">
        <!-- Navbar -->
        <x-navbars.navs.auth titlePage="Administradores"></x-navbars.navs.auth>
        <!-- End Navbar -->
                ...
                <div class=" pb-0 p-3">
                    <div class="row">
                        <div class="col-12 text-end">
                            <a class="btn bg-gradient-dark mb-0" href="{{ route('admin.create') }}"><i
                                    class="material-icons text-sm">add</i>&nbsp;&nbsp;Novo Administrador</a>
                        </div>
                    </div>
                </div>
            </div>
                                        ...
                                        @foreach ($users as $user)
                                            <tr>
                                                ...
                                                {{-- <td class="align-middle text-center text-sm">
                                                    <span
                                                        class="badge badge-sm bg-gradient-{{ $user->status === 'Ativo' ? 'success' : 'danger' }}">
                                                        {{ $user->status }}
                                                    </span>
                                                </td> --}}
